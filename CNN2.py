...
# Loading data for train/validation
...
# Loading and preprocessing data for test
...
# Tokenizing text and converting to sequences
tokenizer = Tokenizer()
...
# Defining checkpoints/saving best model weights
